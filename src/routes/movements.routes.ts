import { createMovement, getMovements, updateMovement, getMovementsByPart, deleteMovement, freebd } from "../controllers/movements.controller";
...
route.delete('/freebd', authMiddleware, freebd);
